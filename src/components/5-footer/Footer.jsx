  ...
  return (
    <footer className="Footer flex ">
      <section className="about ">
        ...
        <p>
          <bdi>
            منصة تقدم مجموعة واسعة من المنتجات وخدمات الطباعة لعملائنا، إلى كل
            من يبحث عن مكان واحد لمطبوعاته حيث يمكنك الحصول على خدمات "سريعة" و
            "جودة عالية" و "سعر مناسب" يلائم جميع أذواق العملاء. مع الاستمرار في
            الاستثمار في أحدث التقنيات التي تمكننا من تقديم حلول طباعة عالية
            الجودة.
          </bdi>
        </p>
